...
def display_settings_image(setting_index):
    ...
    # These are just the base names - the actual brightness and mode images will be dynamic
    settings_base_images = [
        'playlist.png',
        'hell_0.png',  # This gets replaced with current brightness level
        'mode_radio.png',  # This gets replaced with current mode
        'Aus.png'
    ]
    ...
    if setting_index < len(settings_base_images):
        ...
        elif setting_index == 2:  # mode setting
            from settings import settings_manager
            current_mode_image = f"mode_{'song' if settings_manager.music_mode else 'radio'}.png"
